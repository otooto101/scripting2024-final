...
const HomePage = () => {
    const initialProducts = [
        { id: 1, image: tiktok, name: 'Create a TikTok marketing strategy', price: 1200 },
        { id: 2, image: textmessage, name: 'Send text message campaigns ', price: 1000 },
        { id: 3, image: contentmarketing, name: 'Start a content marketing program', price: 3100 },
